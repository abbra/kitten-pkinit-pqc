...
- `draft-bokovoy-kitten-pkinit-pqc-00` (ML-KEM key establishment)
...
- **C5a/C5b**: implement the KEM draft. First attempt is ML-KEM. They
  ...
  err 65 (see Note 4). Both can verify ML-DSA.
...
KDF: HKDF-SHA-512 (authenticated in KDCKEMInfo).
Client signs ML-DSA; KDC signs ECDSA.
**PQ KE + PQ client auth; KDC auth traditional.**
...
### Note 4: Downgrade Rules After err 65
